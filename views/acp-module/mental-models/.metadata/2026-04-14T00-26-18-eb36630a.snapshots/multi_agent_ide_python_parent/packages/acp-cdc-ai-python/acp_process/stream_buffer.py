    ...
    def _flush_window(self, key: tuple[str, WindowType], is_final: bool) -> str | None:
        ...
        match window.wtype:
            ...
            case (
                ...
                | WindowType.USAGE
                | WindowType.CONFIG_OPTION
                | WindowType.SESSION_INFO
            ):
...
def route_acp_update(
    ...
    match update.session_update:
        case "agent_message_chunk":
            update = update
            return buf.append_text(node_id, session_key, WindowType.MESSAGE, _chunk_text(update))
        ...
        case "usage_update":
            ...
            return buf.append_event(node_id, session_key, WindowType.USAGE, event)

        case "config_option_update":
            update = update
            event = ConfigOptionUpdateEvent(
                session_key=session_key,
                config_options=[
            ...
            return buf.append_event(node_id, session_key, WindowType.CONFIG_OPTION, event)
        ...
        case "session_info_update":
            ...
            return buf.append_event(node_id, session_key, WindowType.SESSION_INFO, event)
