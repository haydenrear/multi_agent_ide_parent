...
/**
 * COPIED FROM spring mcp agent utils!!!
...
public class AskUserQuestionTool {
     ...
     */
    private final Function<QuestionContext, Map<String, String>> questionAnswerFunction;

    private final boolean answersValidation;

    public record QuestionContext(List<Question> questions, String sessionId) {}

    protected AskUserQuestionTool(Function<QuestionContext, Map<String, String>> questionAnswerFunction,
    ...
    public String askUserQuestion(
        ...
        Map<String, String> result = this.questionAnswerFunction.apply(new QuestionContext(questions, sessionId));
    ...
    public static class Builder {
        ...
        private Function<QuestionContext, Map<String, String>> questionAnswerFunction;
        ...
        public Builder questionAnswerFunction(Function<QuestionContext, Map<String, String>> questionAnswerFunction) {
