...
| Spring integration tests (`./gradlew :multi_agent_ide_java_parent:multi_agent_ide:test -Pprofile=integration`) | ~5-10 minutes        | 600000ms     |
...
```shell
./gradlew :multi_agent_ide_java_parent:acp-cdc-ai:test -Pprofile=acp-integration
```
